 ...
 * Please see http://developer.android.com/training/sync-adapters/creating-authenticator.html
...
public class MyBakingAuthenticator extends AbstractAccountAuthenticator {
    public MyBakingAuthenticator(Context context) {
        super(context);
    }
