...
/**
 * Created by gaochuang on 2017/12/13.
 */

final class EventLogger implements Player.EventListener, MetadataOutput,
    ...
    public EventLogger(MappingTrackSelector trackSelector, Context mContext) {
    ...
    public void onPlayerError(ExoPlaybackException e) {
        ...
        switch (e.type){
            case ExoPlaybackException.TYPE_SOURCE:
                errorMessage = "源文件发生错误: "+e.rendererIndex;
                break;
            case ExoPlaybackException.TYPE_RENDERER:
                errorMessage = "播放发生错误：" + e.rendererIndex;
                break;
            default:
                errorMessage = "播放发生其他错误：" + e.rendererIndex;
        }
